...
assert_checkalmostequal ( x1 , ya1 , %eps );
assert_checkalmostequal ( x1 , ya11 , %eps );
assert_checkalmostequal ( x1 , ya111 , %eps );
assert_checkalmostequal ( x1 , ya1111 , %eps );
assert_checkalmostequal ( x2 , ya2 , %eps );
assert_checkalmostequal ( x2 , ya22 , %eps );
...
assert_checkalmostequal ( x1 , yh1 , %eps );
assert_checkalmostequal ( x1 , yh11 , %eps );
assert_checkalmostequal ( x1 , yh111 , %eps );
assert_checkalmostequal ( x1 , yh1111 , %eps );
assert_checkalmostequal ( x2 , yh2 , %eps );
assert_checkalmostequal ( x2 , yh22 , %eps );
...
assert_checkalmostequal ( x1 , yv1 , %eps );
assert_checkalmostequal ( x1 , yv11 , %eps );
assert_checkalmostequal ( x1 , yv111 , %eps );
assert_checkalmostequal ( x1 , yv1111 , %eps );
assert_checkalmostequal ( x2 , yv2 , %eps );
assert_checkalmostequal ( x2 , yv22 , %eps );
...
assert_checkalmostequal ( x1 , yd1 , %eps );
assert_checkalmostequal ( x1 , yd11 , %eps );
assert_checkalmostequal ( x1 , yd111 , %eps );
assert_checkalmostequal ( x1 , yd1111 , %eps );
assert_checkalmostequal ( x2 , yd2 , %eps );
assert_checkalmostequal ( x2 , yd22 , %eps );
